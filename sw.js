const BFG_SW_VERSION = '4.51';
const CACHE_NAME = 'briefing-fdf-test-v4.51-meteo-equilibree-r1';

const LOCAL_ASSETS = [
  './manifest.json',
  './icons/icon-180.png',
  './icons/apple-touch-icon.png',const BFG_SW_VERSION = '4.52';
const CACHE_NAME = 'briefing-fdf-test-v4.52-persistance-metar-taf-r1';
